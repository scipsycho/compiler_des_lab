...
#line 30 "yacc.y" /* yacc.c:1646  */
    {  reg[(yyvsp[-2])] = (yyvsp[0]); (yyval) = (yyvsp[0]); printf("Index = %d, Val: %d\n",(yyvsp[-2]),(yyvsp[0])); }
